...
class AudioCaptureDevice:
    ...
    def __init__(
        ...
        Args:
            ...
            chunk_duration_ms: Duration of each audio chunk in milliseconds (default: 32ms = 512 samples at 16kHz for Silero VAD)
...
class ContinuousAudioCapture:
    ...
    def __init__(
        ...
        Args:
            ...
            chunk_duration_ms: Chunk duration in milliseconds (default: 32ms = 512 samples at 16kHz for Silero VAD)
